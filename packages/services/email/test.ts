 ...
 *   DATABASE_URL="postgresql://prashn:prashn@localhost:5432/prashn" \
...
async function main() {
  ...
  const { data, error } = await resend.emails.send({
    ...
    html: `
      <div style="font-family: 'Inter', sans-serif; max-width: 560px; margin: 0 auto; padding: 32px; background: #121319; color: #e4e1eb; border-radius: 12px;">
        <h2 style="color: #bdc2ff; margin: 0 0 8px;">Prashn Email Test</h2>
        ...
        <p style="color: #454653; font-size: 11px;">— Prashn Backend</p>
      </div>
    `,
  });
  ...
  console.log(`   Subject: Prashn — Test Email ✅`);
}
