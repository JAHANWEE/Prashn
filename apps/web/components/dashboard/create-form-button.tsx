...
export function CreateFormButton() {
  ...
  return (
    <button
      ...
      className="w-full bg-[#fca9d4] text-[#0a0a0f] text-[13px] font-medium py-4 rounded-lg flex items-center justify-center gap-1 mb-8 hover:opacity-90 transition-opacity active:scale-95 duration-75 disabled:opacity-50"
    >
