export type PreviewTheme = "default" | "terminal" | "chat" | "anime" | "cyberpunk" | "studio" | "gaming" | "retro" | "space" | "nature" | "minimal";

export const THEMES: { id: PreviewTheme; label: string; icon: string; color: string; description: string }[] = [
  { id: "default", label: "Default", icon: "dark_mode", color: "#fca9d4", description: "Card-based steps" },
  { id: "terminal", label: "Terminal", icon: "terminal", color: "#22c55e", description: "IDE experience" },
  { id: "chat", label: "Chat", icon: "chat", color: "#60a5fa", description: "Messaging app" },
